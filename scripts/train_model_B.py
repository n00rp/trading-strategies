#!/usr/bin/env python3
"""Train Model B: Mean Reversion RL Agent.

Standalone training script — run locally for full training.

Usage:
    python scripts/train_model_B.py [--timesteps 500000] [--symbol sp500]

Output:
    models/model_B_mean_reversion.zip (SB3 PPO model)
"""
...
CONFIG = {
    ...
    "model_dir": "models",
    "model_name": "model_B_mean_reversion",
}


def main():
    parser = argparse.ArgumentParser(description="Train Model B: Mean Reversion")
